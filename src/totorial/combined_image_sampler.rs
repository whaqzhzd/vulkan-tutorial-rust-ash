...
//! cargo run --features=debug combined_image_sampler
//!
...
impl Vertex {
    ...
    pub fn get_attribute_descriptions() -> [VertexInputAttributeDescription; 3] {
        ...
        attribute_descriptions[2].offset =
            std::mem::size_of::<Vector2<f32>>() as u32 + std::mem::size_of::<Vector3<f32>>() as u32;
...
impl HelloTriangleApplication {
    ...
    pub(crate) fn create_graphics_pipeline(&mut self) {
        let vert_shader_code = Self::read_file(Path::new("src/shader/image_sampler_vert.spv"));
        let frag_shader_code = Self::read_file(Path::new("src/shader/image_sampler_frag.spv"));
    ...
    fn create_texture_image_view(&mut self) {
        self.texture_image_view = self.create_image_view(self.texture_image, Format::R8G8B8A8_SRGB);
    }
    ...
    fn create_image_view(&mut self, image: Image, format: Format) -> ImageView {
